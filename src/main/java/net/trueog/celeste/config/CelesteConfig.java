...
public class CelesteConfig {
    ...
    private void buildFromConfigurationSectionWithGlobal(ConfigurationSection section, CelesteConfig globalConfig) {
        ...
        shootingStarsPerMinuteMeteorShower = section.getDouble(
                "shooting-stars-per-minute-during-meteor-showers", globalConfig.shootingStarsPerMinuteMeteorShower);
        ...
        fallingStarsSoundEnabled =
                section.getBoolean("falling-stars-sound-enabled", globalConfig.fallingStarsSoundEnabled);
